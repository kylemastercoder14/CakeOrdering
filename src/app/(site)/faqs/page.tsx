    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <p className="text-center text-lg font-medium text-[#452E19] mb-12 max-w-2xl mx-auto">
          ...
          customers. If you have any other questions, feel free to reach out to us!
        </p>
        ...
        <div className="mt-16 text-center">
          ...
          <Link href="/contact-us" className="bg-[#8BC34A] text-white px-8 py-3 rounded-full font-medium hover:bg-[#7CB342] transition-colors duration-200 shadow-md">
            Contact Support
          </Link>
        </div>
      </div>
