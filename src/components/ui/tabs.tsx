...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center w-full border-b rounded-lg bg-transparent p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
